...
public class MainActivity extends Activity implements TaskFragment.TaskCallbacks, OnItemClickListener, OnSharedPreferenceChangeListener {
	...
	private void initializeNavigationDrawer() {
		...
		drawerList.setAdapter(new ArrayAdapter<String>(this, R.layout.list_item_drawer_item, modeNames));
	...
	private void setupActionBarForNotes() {
		...
		ArrayAdapter<String> modesAdapter = new ArrayAdapter<String>(actionBar.getThemedContext(), android.R.layout.simple_spinner_item, android.R.id.text1, modes);
		...
		ArrayAdapter<String> matchNumberAdapter = new ArrayAdapter<String>(actionBar.getThemedContext(), android.R.layout.simple_spinner_item, android.R.id.text1, matchNumberList);
