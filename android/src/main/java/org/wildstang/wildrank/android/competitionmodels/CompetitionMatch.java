package org.wildstang.wildrank.android.competitionmodels;

public class CompetitionMatch {

    private String key;
    private int[] redAllaince;
    private int[] blueAllaince;
    ...
    public boolean isElimMatch() {
        ...
        return (compLevel == CompetitionLevel.QUARTERFINALS || compLevel == CompetitionLevel.SEMIFINALS || compLevel == CompetitionLevel.FINALS);
