...
import org.wildstang.wildrank.android.adapters.SerializableSpinnerAdapter;

public class SerializableSpinnerView extends JSONSerializableView implements OnItemSelectedListener, OnClickListener {
    ...
    public void writeContentsToBundle(Bundle b) {
        b.putString(key, spinner.getSelectedItem().toString());
    ...
    private void updateDeleteButton() {
        ...
        for (String resourceString : resourceStrings) {
            if (spinner.getItemAtPosition(position).equals(resourceString)) {
